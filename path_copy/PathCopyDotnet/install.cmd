...
xcopy ".\copyicon.ico" "%userprofile%\pathcopy\" /Y

REM file
REG ADD HKCU\Software\Classes\*\shell\pathcopy /d "Copy Path" /f
REG ADD HKCU\Software\Classes\*\shell\pathcopy /v Icon /d "%userprofile%\pathcopy\copyicon.ico" /f
...
REG ADD HKCU\Software\Classes\Directory\shell\pathcopy /v Icon /d "%userprofile%\pathcopy\copyicon.ico" /f
...
REG ADD HKCU\Software\Classes\Directory\Background\shell\pathcopy /v Icon /d "%userprofile%\pathcopy\copyicon.ico" /f
...
REG ADD HKCU\Software\Classes\Drive\shell\pathcopy /v Icon /d "%userprofile%\pathcopy\copyicon.ico" /f
